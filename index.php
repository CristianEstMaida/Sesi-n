                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                  <div class="card-body p-5 text-center">
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                      ...
                      <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="registro.php">¿Olvidé la contraseña?</a></p>
                    ...
                    <div>
                      <p class="mb-0">¿No tenés una cuenta? <a href="registro.php" class="text-white-50 fw-bold">Registrarse</a>
                      </p>
                    </div>
